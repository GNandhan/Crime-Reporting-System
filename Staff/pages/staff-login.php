    ...
    <section class="container my-4">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-lg-6 col-xl-6"> 
                <div class="fs-2 fw-semibold text-secondary border-start border-3 px-3 mb-4">Staff login</div>
...
if($check>0)
{
 ...
 echo '<script type="text/javascript">window.location = "staff-home.php"</script>';
} 
else
{
